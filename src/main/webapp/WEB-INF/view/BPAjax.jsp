    ...
    <div class="dashboard-main-wrapper">
      ...
      <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.do"><img class="logo-img" src="/pp/assets/images/logo5.png" alt="logo" width="140px"></a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            <a class="nav-link nav-user-img" href="#" id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="/pp/assets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a>
...
John Abraham</h5>
       ...
       <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    <a class="d-xl-none d-lg-none" href="index.do">Dashboard</a>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="BPsearch.do">BP Order Search</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <table class="table">
                                        ...
                                        <%for(int i=0; i<ListPro.size(); i++){		
											...
											<tr>
												<th scope="row"><%=i %></th>
												<td onclick="SetCardCode();" style="cursor:pointer" class="cardcode"><%=ListPro.get(i).getCardCode() %></td>
												<td><%=ListPro.get(i).getCardName() %></td>
											</tr>
										<% }%>                                                                                    
                                        </tbody>
                                    </table>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>                                            
                                            <%for(int i=0; i<OrderList.size(); i++){		
												...
												<tr>
													<th scope="row"><%=i %></th>
													<td><%=OrderList.get(i).getDocNum() %></td>
													<td><%=OrderList.get(i).getVisOrder() %></td>
													<td><%=OrderList.get(i).getDocEntry() %></td>
													<td><%=OrderList.get(i).getItemCode() %></td>
													<td><%=OrderList.get(i).getItemName() %></td>
													<td><%=OrderList.get(i).getWhsCode() %></td>
													<td><%=OrderList.get(i).getWhsName() %></td>
													<td><%=OrderList.get(i).getQuantity() %></td>
													<td><%=OrderList.get(i).getPrice() %></td>
													<td><%=OrderList.get(i).getLineTotal() %></td>
													<td><%=OrderList.get(i).getOnHand() %></td>
												</tr>
											<% }%>
                                        </tbody>
                                    </table>
    ...
    <script src="/pp/assets/vendor/custom-js/jquery.multi-select.html"></script>
